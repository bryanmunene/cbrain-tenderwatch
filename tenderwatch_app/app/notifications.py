...
def send_email_notification(settings, tenders):
    ...
    try:
        ...
        <body>
            <h2>TenderWatch Alert</h2>
            <p>Found {len(tenders)} new tender opportunity{'ies' if len(tenders) > 1 else 'y'} matching your criteria:</p>
        """
...
def notify_new_tenders(tenders):
    ...
    try:
        ...
        # Filter tenders by score threshold
